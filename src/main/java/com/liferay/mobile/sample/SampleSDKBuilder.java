...
import com.liferay.mobile.sample.BaseBuilder;
import com.liferay.mobile.sample.AS3Util;
...
public class SampleSDKBuilder extends BaseBuilder {
	...
	protected VelocityContext getVelocityContext(
		...
		String className = asUtil.getServiceClassName(filter);
		...
		context.put(UPLOAD_DATA, AS3Util.UPLOAD_DATA);
		context.put(INTEGER, AS3Util.INTEGER);
		context.put(JSON_OBJECT_WRAPPER, AS3Util.JSON_OBJECT_WRAPPER);
		context.put(LANGUAGE_UTIL, asUtil);
